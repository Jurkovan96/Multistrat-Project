    ...
    <table class="table table-dark table-hover table-bordered">
      ...
      <c:forEach items="${taskList}" var="task">
        <tr style="text-align: center">
          ...
          <td>
            <button class="btn btn-light"><a style="color:black" href="/tasks/${task.taskId}">Mark as solved</a>
            </button>
          </td>
          <td>
            <button class="btn btn-light"><a style="color:black" href="/tasks/${task.taskId}/review">Add
              review</a></button>
          </td>
