...
<div class="w3-main" style="margin-left:320px;">
  ...
  <c:forEach items="${listOfInternships}" var="internship">
    <div id="internshipBody" class="w3-container internship">
      ...
      <hr>
      <button class="btn btn-danger"><a style="color: white" href="/homepageCompany/${internship.internshipId}/delete">Delete
        internship</a></button>
      <button class="btn btn-info"><a style="color: white" href="/internship/${internship.internshipId}/update">Edit
        internship</a></button>
    </div>
  </c:forEach>
